...
namespace Collection.Api.Service {
    ...
    public abstract class ApiBase<P> : ApiBaseBase<RequestModel>
        ...
        protected void Validate() {
            ...
            //}
            var CertAddress = @"C:\certificate\ceshizhuzhanghu\intfoo30_898_33.cer|C:\certificate\ceshizhuzhanghu\intfoo30_898_33.pfx";
            var CertPassword = "123456";
            var UserKey = "5d39980acc6e4d6f91b04720c3414ef6";
            var aesAddress = CertAddress.Split('|')[1];
            ...
            //解密data
            var json = Encrpty.AESDecrypt(model.Data, Encrpty.RSADecrypt(model.EncryptKey, aesAddress, CertPassword));
            // 反序列化Json为参数对象
