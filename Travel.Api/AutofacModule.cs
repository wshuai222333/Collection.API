...
namespace Collection.Api {
    ...
    public class AutofacModule : Autofac.Module {
        ...
        protected override void Load(ContainerBuilder builder) {
            //petapoco仓储注入
            var petapocobase_repository = Assembly.Load(new AssemblyName("Collection.PetaPoco.Repositories"));
            ...
            var apiservice = Assembly.Load(new AssemblyName("Collection.Api.Service"));
